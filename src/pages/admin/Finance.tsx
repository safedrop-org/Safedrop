      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <SelectContent>
              <SelectItem className="p-1" value="daily">
                يومي
              </SelectItem>
              <SelectItem className="p-1" value="monthly">
                شهري
              </SelectItem>
              <SelectItem className="p-1" value="yearly">
                سنوي
              </SelectItem>
            </SelectContent>
          </Select>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          value={
            isLoading
              ? "جاري التحميل..."
              : formatCurrency(financialData?.platform_profit)
          }
          icon={<DollarSign size={20} />}
          description={getPeriodText()}
        ...
        <StatCard
          ...
          value={
            isLoading
              ? "جاري التحميل..."
              : formatCurrency(financialData?.driver_profit)
          }
          icon={<Truck size={20} />}
          description={getPeriodText()}
            ...
            <CardContent>
              <div className="h-80 flex items-center justify-center bg-gray-50 rounded-md">
                <p className="text-gray-500">
                  سيتم عرض الرسم البياني اليومي هنا
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="monthly" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-80 flex items-center justify-center bg-gray-50 rounded-md">
                <p className="text-gray-500">
                  سيتم عرض الرسم البياني الشهري هنا
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="annual" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-80 flex items-center justify-center bg-gray-50 rounded-md">
                <p className="text-gray-500">
                  سيتم عرض الرسم البياني السنوي هنا
                </p>
              </div>
            </CardContent>
          </Card>
