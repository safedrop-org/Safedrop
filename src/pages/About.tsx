      ...
      <main className="flex-grow">
        ...
        <section className="bg-safedrop-primary text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">{t('aboutHero')}</h1>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-safedrop-primary">{t('ourStory')}</h2>
                <p className="text-gray-700 mb-4">{t('ourStoryDescription1')}</p>
                <p className="text-gray-700 mb-4">{t('ourStoryDescription2')}</p>
              </div>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <img alt="About SafeDrop" className="w-full h-auto" src="/lovable-uploads/ff85dfb5-9750-46d8-a071-2b625d81f41a.png" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-safedrop-primary">{t('ourValues')}</h2>
              <p className="mt-4 text-lg text-gray-600">{t('ourValuesDescription')}</p>
            </div>
